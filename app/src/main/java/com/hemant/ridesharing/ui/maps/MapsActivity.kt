package com.hemant.ridesharing.ui.maps
...
import com.hemant.ridesharing.R
import com.hemant.ridesharing.data.network.NetworkService
import com.hemant.ridesharing.utils.AnimationUtils
import com.hemant.ridesharing.utils.MapUtils
import com.hemant.ridesharing.utils.PermissionUtils
import com.hemant.ridesharing.utils.ViewUtils
...
//
        ...
        private fun addOriginDestinationMarkerAndGet(latLng: LatLng): Marker {
            val bitmapDescriptor =
                BitmapDescriptorFactory.fromBitmap(MapUtils.getDestinationBitmap())
            return googleMap.addMarker(
                MarkerOptions().position(latLng).flat(true).icon(bitmapDescriptor)
            )
        }
        ...
        private fun setUpLocationListener() {
            ...
            locationCallback = object : LocationCallback() {
                override fun onLocationResult(locationResult: LocationResult) {
                    ...
                    // eg-update the location of the user on server
                }
            }
